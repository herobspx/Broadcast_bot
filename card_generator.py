...
# BAM | SPX card generator — Broadcast Bot
# مطابق لبوت الإشارات:
# - يستخدم card_bg.png بنفس أبعادها الأصلية بدون قص
# - خطوط SF-Pro-Display-Bold/Regular
# - بدون خطوط جدول
# - بدون إطار إضافي
...
def _load_background() -> Image.Image:
    ...
    # fallback لو الخلفية غير موجودة
...
def generate_trade_card(
    ...
    # نحافظ على أبعاد الخلفية الأصلية بدون قص أو تمديد
    img = bg.convert("RGBA")
    ...
    # إحداثيات نسبية حسب أبعاد الخلفية
    x0 = int(W * 0.040)
    y0 = int(H * 0.125)
